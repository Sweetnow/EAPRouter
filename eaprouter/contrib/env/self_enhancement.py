...
**Description:** Manages a Self-Enhancement experiment where agents evaluate their percentile rankings (0-100) across 8 dimensions relative to a reference university student population.
...
**Experiment Task:**
You need to evaluate your percentile ranking (0-100) in 8 dimensions relative to a reference university student population. A percentile of 50 means you are at the median (average), 75 means you are better than 75% of students, 25 means you are better than 25% of students.
