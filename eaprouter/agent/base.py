...
import json_repair
from eaprouter.config import extract_json
from eaprouter.env.router_base import RouterBase, TokenUsageStats
...
"""
    ...
    def get_system_prompt(self, tick: int, t: datetime) -> str:
        ...
        return f"""You are an intelligent agent simulating a real-world person in EAPRouter. Your role is to behave authentically as a human being, making decisions and taking actions that reflect realistic human behavior, motivations, and responses to your environment.
