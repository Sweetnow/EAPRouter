"""
Base class for Router implementations in SimFramework V2.
...
from simframework.env.base import EnvBase
from simframework.config import get_llm_router_and_model, extract_json
from simframework.logger import get_logger
from simframework.env.function_parser import FunctionParser, FunctionParts
from simframework.env.pydantic_collector import PydanticModelCollector
